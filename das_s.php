...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center">
        ...
        <span class="fw-bold">Skill Department</span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link active" href="./das_s.php">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="./skill.php">
              Dashboard
            </a>
          </li>
          <li class="nav-item">
  ...
  <section class="hero-section" id="home">
    <div class="container text-center">
      <h1 class="display-4 fw-bold mb-4">Skill Department</h1>
      <p class="lead mb-4">Enhance your skills with government-recognized certification programs.<br> Unlock better career opportunities with industry-focused training!</p> 
    </div>
  </section>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <div class="row mb-4">
          <div class="col-12">
            <h2 class="mb-4">Skill Department</h2>
          </div>
        ...
        <div class="dashboard-tabs mb-4">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="departments-tab" data-bs-toggle="tab" data-bs-target="#departments-tab-pane" type="button" role="tab">Department</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="services-tab" data-bs-toggle="tab" data-bs-target="#services-tab-pane" type="button" role="tab">Workshop</button>
            </li>
            <li class="nav-item" role="presentation">
                  ...
                  <div class="card department-card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#departmentModal" data-department="Skill Development">View Details</a>
            ...
            <div class="tab-pane fade" id="services-tab-pane" role="tabpanel" aria-labelledby="services-tab" tabindex="0">
              <div class="row" id="services">
                <div class="col-md-6">
                  <div class="card mb-4">
                    <div class="card-body">
                      <h5 class="card-title"><i class="fas fa-certificate me-2 text-primary"></i>Expert lecture From  AI-ML</h5>
                      <p class="card-text">The Skill Development Department conducted an expert lecture on AI-ML for industry-focused learning.</p>
                      <a class="btn btn-primary">Date Not Declare</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <a class="btn btn-primary">View Report</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-lg-4">
        <div class="sidebar mb-4">
          ...
          <h4>Quick Links</h4>
          <ul>
            <li><a><i class="fas fa-angle-right me-2"></i> Skill Training Programs</a></li>
          </ul>
        </div>
        ...
        <div class="sidebar mb-4">
          ...
          <div class="card mb-3">
            <div class="card-body">
              ...
              <a class="btn btn-sm btn-primary">Register</a>
            </div>
          </div>
        </div>
        ...
        <div class="sidebar mb-4">
          ...
          <ul>
            <li><a><i class="fas fa-file-pdf me-2 text-danger"></i> Skill Development Policy</a></li>
          </ul>
        </div>
        ...
        <div class="sidebar">
          ...
          <p><i class="fas fa-envelope me-2"></i> Email: info@skilldepartment.gov.in</p>
          <p><i class="fas fa-map-marker-alt me-2"></i> Address: Skill Department Building, Government Complex, Capital City</p>
          <div class="mt-3">
            <a class="btn btn-primary w-100" id="contact">Contact Us</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 mb-4 mb-md-0">
          <h5>About the Skill Department</h5>
          <p>Gujarat Skill Development provides industry-focused training to enhance employability and bridge the skill gap through government initiatives.</p>
      ...
      <div class="row">
        <div class="col-md-6 text-center text-md-start">
          <p class="mb-0">&copy; 2025 Skill Department. All rights reserved.</p>
        </div>
        <div class="col-md-6 text-center text-md-end">
          <p class="mb-0">
            <a class="text-white me-3">Privacy Policy</a>
            <a class="text-white me-3">Terms of Service</a>
    ...
    departmentModal.addEventListener('show.bs.modal', function (event) {
      ...
      if (departmentData[department]) {
        ...
        let content = `
          ...
          <div class="mt-4">
            <a href="./skill.php" class="btn btn-primary">Visit Department Website</a>
          </div>
        `;
