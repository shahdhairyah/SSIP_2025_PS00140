<?php
require 'config_employee.php'; // Connect to database
...
try {
    ...
    $stmt = $pdo->prepare("SELECT id,department, start_date, deadline, budget, status, progress, status_class 
...
<head>
    <meta charset="UTF-8">
    <title>Project Details - <?php echo htmlspecialchars($project['department']); ?></title>
    <link rel="stylesheet" href="style_V.css">
</head>
<body>

<h2><?php echo htmlspecialchars($project['department']); ?></h2>
