...
// Optional redirect once after login
...
$username = 'root';
$password = '';
$databases = ['skill_db', 'labour_db', 'employment_db', 'departments_db'];
...
//     $stmt = $conn->query("SELECT * FROM auth_users WHERE status = 'pending'");
            ...
            <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                ...
                <div class="profile-section" id="profile-toggle">
                    ...
                    <div class="profile-info">
                        ...
                        <small id="department">Admin</small>
                    </div>
