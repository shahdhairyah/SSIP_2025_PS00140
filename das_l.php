...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="#">
        ...
        <span class="fw-bold">Labour Department</span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a href="./labour.php" class="nav-link" href="#departments">Departments</a>
          </li>
          <li class="nav-item">
  ...
  <section class="hero-section" id="home">
    <div class="container text-center">
      <h1 class="display-4 fw-bold mb-4">Labour Department</h1>
      <p class="lead mb-4">Labour Department of Gujarat oversees worker welfare, minimum <br>wages, employment policies, and skill development initiatives for industries and laborers.</p>
    </div>
  </section>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <div class="row mb-4">
          <div class="col-12">
            <h2 class="mb-4">Labour Department</h2>
          </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="sidebar">
          ...
          <p><i class="fas fa-envelope me-2"></i> Email: info@labourde.gov.in</p>
          <p><i class="fas fa-map-marker-alt me-2"></i> Address: Labour Department Building, Government Complex, Ahmedabad</p>
          <div class="mt-3">
    ...
    <div class="container">
        ...
        <div class="col-md-3 mb-4 mb-md-0">
          <div class="footer-links">
            ...
            <ul>
              ...
              <li><a href="#">Employment Exchange</a></li>
              <li><a href="#">Industrial Safety</a></li>
              <li><a href="#">Labour Welfare</a></li> -->
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 text-center text-md-start">
          <p class="mb-0">&copy; 2025 Labour Department. All rights reserved.</p>
        </div>
