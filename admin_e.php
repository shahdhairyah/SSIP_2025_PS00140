...
function getPendingUsers() {
    ...
    $stmt = $conn->query("SELECT * FROM auth_users WHERE department = 'Employment Department' AND status = 'pending'");
            ...
            <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                ...
                <div class="profile-section" id="profile-toggle">
                    ...
                    <div class="profile-info">
                        ...
                        <small id="department">Admin of <br> Employment Department</small>
                    </div>
