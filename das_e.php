...
<head>
  ...
  <title>Employment Department</title>
  <!-- Bootstrap 5 CSS -->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="#">
        ...
        <span class="fw-bold">employment Department</span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./employment.php">Departments</a>
          </li>
          <li class="nav-item">
  ...
  <section class="hero-section" id="home">
    <div class="container text-center">
      <h1 class="display-4 fw-bold mb-4">Employment Department</h1>
      <p class="lead mb-4"></p>
    </div>
  </section>
            ...
            <div class="tab-pane fade show active" id="departments-tab-pane" role="tabpanel" aria-labelledby="departments-tab" tabindex="0">
              <div class="row" id="departments">
                ...
                <div class="col-md-6">
                  <div class="card department-card mb-4">
                    <div class="card-header">
                      <i class="fas fa-briefcase me-2"></i> Employment Departments
                    </div>
                    <div class="card-body">
      ...
      <div class="col-lg-4">
        ...
        <div class="sidebar mb-4">
          <h4>Upcoming Events</h4>
            ...
            <p>New Events Data Declare soon</p>
            <!-- <div class="card-body">
        ...
        <div class="sidebar">
          ...
          <p><i class="fas fa-envelope me-2"></i> Email: info@Employmentdepguj.gov.in</p>
          <p><i class="fas fa-map-marker-alt me-2"></i> Address: Employment Department Building, Government Complex, Capital City</p>
          <div class="mt-3">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 mb-4 mb-md-0">
          <div class="footer-links">
            <h5>Departments</h5>
            <ul>
              <li><a href="./employment.php">Employment Department</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 text-center text-md-start">
          <p class="mb-0">&copy; 2025 Employment Department. All rights reserved.</p>
        </div>
